...
class OntoProteinTrainer(Trainer):
    ...
    def prediction_step(
        ...
        prediction_score['precision_at_l5'] = logits[3].get('precision_at_l5', torch.tensor(0.0))
        prediction_score['precision_at_l2'] = logits[3].get('precision_at_l2', torch.tensor(0.0))
        prediction_score['precision_at_l'] = logits[3].get('precision_at_l', torch.tensor(0.0))
